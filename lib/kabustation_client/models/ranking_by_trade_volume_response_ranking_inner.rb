...
module KabustationClient
  class RankingByTradeVolumeResponseRankingInner
    ...
    # 売買高急増（％）
    attr_accessor :rapid_trade_percentage
    ...
    def self.attribute_map
      {
        ...
        :'rapid_trade_percentage' => :'RapidTradePercentage',
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `KabustationClient::RankingByTradeVolumeResponseRankingInner` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `KabustationClient::RankingByTradeVolumeResponseRankingInner`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
      ...
      if attributes.key?(:'rapid_trade_percentage')
        self.rapid_trade_percentage = attributes[:'rapid_trade_percentage']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          rapid_trade_percentage == o.rapid_trade_percentage &&
    ...
    def hash
      [_false, trend, average_ranking, symbol, symbol_name, current_price, change_ratio, rapid_trade_percentage, trading_volume, current_price_time, change_percentage, exchange_name, category_name].hash
    end
